 ...
 */
   ...
   */
  #define SHORT_BUILD_VERSION "1.1.0-RC8 BBDual"

  /**
   * Verbose version identifier which should contain a reference to the location
   * from where the binary was downloaded or the source code was compiled.
   */
  #define DETAILED_BUILD_VERSION SHORT_BUILD_VERSION " 1.1.0-RC8 BigBox Dual"
   ...
   * Marlin repository.
   */
  #define SOURCE_CODE_URL "https://github.com/markoaurelije/Marlin"
